...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        """Test for the db_storage.py module docstr"""
    ...
    def test_dbs_func_docstrings(self):
        """Test for the presence of docstrs in DBStorage methods"""
...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def save(self):
        """Test that save properly saves objs to file.json"""
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Test that get returns specific obj, or none"""
